...
/*    */ 
/*    */ public class CopyOfSelectStore
...
headers.put("Accept","image/gif, image/x-xbitmap, image/jpeg, image/pjpeg, application/x-shockwave-flash, application/x-ms-application, application/x-ms-xbap, application/vnd.ms-xpsdocument, application/xaml+xml, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, */*");
headers.put("Referer","http://reserve.apple.com/WebObjects/ProductReservation.woa/wa/reserveProduct?lang=zh&country=CN");
headers.put("Accept-Language","ja");
headers.put("Content-Type","application/x-www-form-urlencoded");
headers.put("UA-CPU","x86");
headers.put("Accept-Encoding","gzip, deflate");
headers.put("User-Agent","Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 2.0.50727; .NET CLR 3.0.04506.648; .NET CLR 3.5.30729)");
...
/* 62 */       if (index > 0)
/*    */       {
/* 64 */         index = sb.indexOf("<img alt=\"iPad\"");
/* 65 */         if (index > 0) {
